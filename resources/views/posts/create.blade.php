                                        ...
                                        <div class="form-row material__item__row mb-1" data-no="1">
                                            <div class="col material__name">
                                                <div class="input-group align-items-center">
                                                    ...
                                                    <input type="text" name="material[1][item][1][name]" id="" class="form-control rounded-sm" placeholder="고추장" aria-describedby="helpId">
                                                </div>
                                            </div>
                                            <div class="col material__unit">
                                                <div class="input-group align-items-center">
                                                    <input type="text" name="material[1][item][1][unit]" id="" class="form-control rounded-sm" placeholder="30g" aria-describedby="helpId">
                        ...
                        <div class="row recipe mb-3" data-no="1">
                            ...
                            <div class="col">
                                <div class="input-group align-items-center">
                                    ...
                                    <textarea class="form-control rounded-sm recipe__content" name="recipe[1][content]" id="" cols="30" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="col">
                                <label for=""></label>
